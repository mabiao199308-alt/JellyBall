...
function playWallHitSfx(impact, options = {}) {
  ...
  gain.gain.value = clamp(0.45 + (impact - WALL_HIT_SFX_MIN_IMPACT) / 500, 0.45, 1);
  src.connect(gain);
...
function addGeneratedSlotAbove() {
  ...
  if (selected === "baseTrack") {
    ...
    world.damageTrackSlotsSinceSpawn += 1;
  ...
  if (selected === "damageTrack") {
    ...
    world.baseTrackSlotsSinceSpawn += 1;
    world.gearSlotsSinceSpawn += 1;
    return;
  }
