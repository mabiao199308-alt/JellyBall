export const CFG_STORAGE_KEY = "swipe_debug_cfg_v2";
export const CFG_DEFAULT_OVERRIDE_KEY = "swipe_debug_default_cfg_v1";
export const BEST_STORAGE_KEY = "swipe_best_meters_v1";
export const JELLY_CFG_STORAGE_KEY = "swipe_jelly_cfg_v1";
...
export const CODE_DEFAULT_SAVE_ENDPOINT_FALLBACK = "http://127.0.0.1:8130/__save_code_defaults";
